// Purpose: Normalise legacy Tailwind class names across all .ts/.tsx source files.
//          Replaces pixel-specific text sizes with Tailwind scale equivalents,
//          and converts inline backdropFilter styles to class names.
//
// Usage: node scripts/normalize.js  (or: npm run normalize)
...
files.forEach(file => {
    ...
    // Replace style={{ backdropFilter: "blur(...)" }} if it's the only prop inside style={}
